...
- 2022年5月22日 深夜 更新了内置的礼物数据库，并重做了礼物显示
### 画饼
- 黑白名单屏蔽功能
- 过低等级和无粉丝团路人屏蔽功能
- 舰长和高等级老粉进入事件【待官方提供】
...
GitEE各种弱智废物，早不做审核和监管，上面发话了就乱成一团，连申请开源的功能都一堆Bug【见SBGitEE.png】  
...
```
- 也可以使用已经加入白名单的测试房间
目前已经有白名单，且弹幕够多便于测试的直播间
```
某喵的云养猫：4639581
修勾的互联网夜店：3645373
Zelo-Balance的空间站转播：14047
弹幕姬作者CopyLiu的EVE行情播报：5051
Daan大聪明的弹幕游戏：24075835
```
